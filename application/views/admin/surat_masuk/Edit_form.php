<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumbitem"><a href="<?= site_url('admin/user') ?>">User</a></li>
            ...
            <div class="card-body">
                <form action="<?= site_url('admin/surat_masuk/edit') ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="id" value="<?= $surat->id; ?>" required />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" name="tgl_terima" value="<?= $surat->tgl_terima; ?>" placeholder="TANGGAL TERIMA SURAT" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="old_image" value="<?= $surat->image; ?>" required />
                    </div>
